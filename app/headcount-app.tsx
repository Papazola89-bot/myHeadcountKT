...
export default function HeadcountApp(){
  ...
  const [year,setYear]=useState("Semua tahun"),[query,setQuery]=useState(""),[selected,setSelected]=useState<Student|null>(null),[deleteCandidate,setDeleteCandidate]=useState<Student|null>(null),[editingGroup,setEditingGroup]=useState<InterventionGroupRecord|null>(null),[recordGroupId,setRecordGroupId]=useState(""),[modal,setModal]=useState<"add"|"analysis-import"|"delete-student"|"intervention"|"group"|"submit"|"profile"|"admin"|"transfer"|"import"|null>(null);
  ...
  return <div className="app-shell">
    ...
    {selected&&!modal&&<StudentDrawer student={selected} close={()=>setSelected(null)} intervention={()=>setModal("intervention")} transfer={()=>setModal("transfer")} remove={()=>{setDeleteCandidate(selected);setModal("delete-student")}}/>}
