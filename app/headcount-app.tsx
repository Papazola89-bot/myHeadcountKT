...
export default function HeadcountApp(){
  ...
  const [year,setYear]=useState("Semua tahun"),[query,setQuery]=useState(""),[selected,setSelected]=useState<Student|null>(null),[editingGroup,setEditingGroup]=useState<InterventionGroupRecord|null>(null),[recordGroupId,setRecordGroupId]=useState(""),[modal,setModal]=useState<"add"|"analysis-import"|"intervention"|"group"|"submit"|"profile"|"admin"|"transfer"|"import"|null>(null);
