...
export default function HeadcountApp(){
  ...
  const saveInterventionGroup=async(payload:{groupId?:string;groupName:string;skillCode:string;skillName:string;studentIds:string[]})=>{
    if(!appsScriptService)throw new Error(localOnlyMessage);
